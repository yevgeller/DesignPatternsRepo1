...
namespace DesignPatternsRepo1.TagHelpers
{
    public class NavigationTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-regular fa-clone mr-2'></i>&nbsp;Prototype</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-atom mr-2'></i>&nbsp;Singleton</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-plug mr-2'></i>Adapter</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-left-right mr-2'></i>Bridge</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-magnifying-glass-arrow-right mr-2'></i>Composite</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-chart-line mr-2'></i>Decorator</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-igloo mr-2'></i>Facade</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-bowl-rice mr-2'></i>Flyweight</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-door-open mr-2'></i>Proxy</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-link mr-2'></i>Chain of Responsibility</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-bullhorn mr-2'></i>Command</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-language mr-2'></i>Interpreter</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-arrow-up-right-dots mr-2'></i>Iterator</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-tower-cell mr-2'></i>Mediator</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-gift mr-2'></i>Memento</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-eye mr-2'></i>Observer</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-wand-sparkles mr-2'></i>State</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-chess-knight mr-2'></i>Strategy</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-train-tram mr-2'></i>Template Method</div>");
            ...
            else output.Content.AppendHtml("<div><i class='fa-solid fa-arrow-right'></i><i class='fa-solid fa-person-circle-question mr-2'></i>Visitor</div>");
