...
<div>
            ...
            if (this.Pattern == "factory") output.Content.AppendHtml("<div><i class='fa-solid fa-industry mr-2'></i></div>");
            else output.Content.AppendHtml("<div><a asp-page='/Creational/Factory-problem'><i class='fa-solid fa-industry mr-2'></i>Factory</a></div>");
            //                <div><a asp-page='/Creational/Abstract-problem'><i class='fa-solid fa-cube'></i><i class='fa-solid fa-industry mr-2'></i>Abstract Factory</a></div>
            //                <div><a asp-page='/Creational/Builder-problem'><i class='fa-solid fa-helmet-safety mr-2'></i>Builder</a></div>
            //                <div><a asp-page='/Creational/Prototype'><i class='fa-regular fa-clone mr-2'></i>&nbsp;Prototype</a></div>
            //                <div><a asp-page='/Creational/Singleton'><i class='fa-solid fa-atom mr-2'></i>&nbsp;Singleton</a></div>
